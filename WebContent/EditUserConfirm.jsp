		...
		<form action="./EditUserRegist" method="post">
			<table style="width: 400px" class="table table-borderd container padding-y-5">
				...
				<tr>
					...
					<td class="text-center">${sessionScope.user.loginId}</td>
				</tr>
				<tr>
					<th class="color-main text-center">パスワード:</th>
					<td class="text-center">${sessionScope.user.password}</td>
				</tr>
				<tr>
					<th class="color-main text-center">ユーザー名:</th>
					<td class="text-center">${sessionScope.user.userName}</td>
				</tr>
				<tr>
					<th class="color-main text-center">アイコン:</th>
					<td class="text-center"><span class="${sessionScope.user.icon} pe-2x pe-va"></span></td>
				</tr>
				<tr>
					<th class="color-main text-center">プロフィール:</th>
					<td class="text-center">${sessionScope.user.profile}</td>
				</tr>
				<tr>
