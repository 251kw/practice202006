		...
		<table border="1" class="table">
			...
			<c:if
				...
				<tr>
					...
					<input type="checkbox" name="icon" value="icon-user" /><span class="icon-user pe-va"></span><%-- 男性 --%>
					<input type="checkbox" name="icon" value="icon-user-female" /><span class="icon-user-female pe-va"></span><%-- 女性 --%>
					<input type="checkbox" name="icon" value="icon-bell" /><span class="icon-bell pe-va"></span><%-- ベル --%>
					<input type="checkbox" name="icon" value="icon-star" /><span class="icon-star pe-va"></span><%-- 星 --%>
					<input type="checkbox" name="icon" value="icon-moon" /><span class="icon-moon pe-va"></span><%-- 月 --%>
					<input type="checkbox" name="icon" value="icon-rocket" /><span class="icon-rocket pe-va"></span><%-- ロケット --%>
				...
				<tr>
					...
					<input class="btn" type="submit" value="検索" name="btn"/>
