...
<form action="./" method="post">
	<table style="width: 70%" class="table container">
		...
		<tr>
			...
			<td>
				<label><input type="radio"name="icon" value="icon-car" <% if(request.getAttribute("icon").equals("icon-car")){ out.print("checked"); } %>><span></span></label>
				<span class="icon-car pe-2x pe-va"></span>
				<label><input type="radio" name="icon" value="icon-paperclip" <% if(request.getAttribute("icon").equals("icon-paperclip")){ out.print("checked"); } %> ><span></span></label>
				<span class="icon-paperclip pe-2x pe-va"></span>
				<label><input type="radio" name="icon" value="icon-radio" <% if(request.getAttribute("icon").equals("icon-radio")){ out.print("checked"); } %> ><span></span></label>
