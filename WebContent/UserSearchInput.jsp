			...
			<form action="./usi" method="post">
				...
				<table border="1" class="table">
					...
					<tr>
						...
						<td>
							<input type="text" pattern="^[0-9A-Za-z]+$" title="半角英数字"  name="loginId" maxlength="15" id="loginId" class="form-control">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="radio" name="icon" value="joy">
							...
							<input type="radio" name="icon" value="moon">
							<span class="icon-moon pe-2x pe-va"></span>&nbsp;
							<input type="radio" name="icon" value="smile">
							<span class="icon-smile pe-2x pe-va"></span>&nbsp;
							<input type="radio" name="icon" value="music">
							<span class="icon-music pe-2x pe-va"></span>&nbsp;
							<input type="radio" name="icon" value="cloud">
							<span class="icon-cloud pe-2x pe-va"></span>&nbsp;
							<input type="radio" name="icon" value="ball">
							<span class="icon-ball pe-2x pe-va"></span>&nbsp;
							<input type="radio" name="icon" value="coffee">
							<span class="icon-coffee pe-2x pe-va"></span>&nbsp;
						</td>
					</tr>
					<tr>
						<th><span class="icon-note2 pe-2x pe-va"></span>&nbsp;プロフィール</th>
						<td><textarea rows="5" cols="20" name="profile" class="form-control">
						</textarea></td>
					</tr>
					<tr>
						<td colspan="2" class="text-left"><input class="btn" type="submit" name="cmd" value="検索">
